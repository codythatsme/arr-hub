...
ship a broad tracker catalogue, full Cardigann selector/login runtime beyond first-pass HTML selector/case features and cookie/one-url/form login execution with multipart forms and selector-derived form values, richer definition auth UX, or trusted
