...
ship a broad tracker catalogue, full Cardigann selector/login runtime beyond first-pass cookie-login execution, richer definition auth UX, or trusted
