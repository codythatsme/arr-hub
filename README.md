...
- Core curated built-ins are the common Newznab presets above plus generic Newznab/Torznab, Nyaa/SubsPlease for anime, public torrent/search examples such as Knaben and TorrentsCSV, and selected high-value private tracker examples already present. Kickass/PirateBay-style public torrent coverage should come through generic Torznab or checksum-pinned remote definitions unless explicitly promoted into the curated set.
