...
ship a broad tracker catalogue, full Cardigann selector/login runtime beyond first-pass HTML selector features and cookie-login execution, richer definition auth UX, or trusted
