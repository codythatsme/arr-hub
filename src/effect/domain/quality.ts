...
export const Quality = {
  ...
  WEBRip1080p:  { id: 15, name: 'WEBRip-1080p',   source: 'webrip',    resolution: 1080, modifier: 'none' },
  WEBRip2160p:  { id: 17, name: 'WEBRip-2160p',   source: 'webrip',    resolution: 2160, modifier: 'none' },
  ...
  Bluray1080p:  { id: 7,  name: 'Bluray-1080p',   source: 'bluray',    resolution: 1080, modifier: 'none' },
  Bluray2160p:  { id: 19, name: 'Bluray-2160p',   source: 'bluray',    resolution: 2160, modifier: 'none' },
  Remux1080p:   { id: 30, name: 'Remux-1080p',    source: 'bluray',    resolution: 1080, modifier: 'remux' },
  Remux2160p:   { id: 31, name: 'Remux-2160p',    source: 'bluray',    resolution: 2160, modifier: 'remux' },
