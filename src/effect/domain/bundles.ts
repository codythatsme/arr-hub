...
const HD_BLURAY_WEB_1080P: Bundle = {
  ...
  version: 1,
  description:
    "TRaSH-inspired 1080p profile preferring Bluray and WEB sources with x265 preference.",
  upgradeAllowed: true,
  minFormatScore: 0,
...
const UHD_BLURAY_WEB_2160P: Bundle = {
  ...
  version: 1,
  description:
    "TRaSH-inspired 2160p profile preferring Bluray and WEB sources with HDR preference.",
  upgradeAllowed: true,
  minFormatScore: 0,
  cutoffFormatScore: 10000,
  minUpgradeFormatScore: 1,
