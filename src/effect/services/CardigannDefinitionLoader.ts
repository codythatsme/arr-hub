...
id: cgpeers
name: CGPeers
description: Private graphics software, tutorials, and game development tracker exposed through a first-pass Gazelle JSON Cardigann definition.
type: private
links:
  - https://cgpeers.to/
version: builtin-cardigann-1
...
id: orpheus
name: Orpheus
description: Private music tracker exposed through a first-pass token-auth Gazelle JSON Cardigann definition.
type: private
links:
