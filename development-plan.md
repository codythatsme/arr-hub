...
- [ ] Implement Option A:
  ...
  - [x] Add GazelleGames to the curated Cardigann built-in catalogue with first-pass X-API-Key JSON object-map selector coverage and Prowlarr-derived games/app/book/audio category mappings.
  - [x] Add AnimeBytes to the curated Cardigann built-in catalogue with first-pass passkey JSON scrape coverage and Prowlarr-derived anime/music/book/game category mappings.
  - [x] Add RuTracker.org to the curated Cardigann built-in catalogue with first-pass POST-login HTML selector coverage and Prowlarr-derived movies/TV/anime/audio/book/game category mappings.
  ...
  - [x] Add PornoLab to the curated Cardigann built-in catalogue with first-pass POST-login HTML selector coverage and Prowlarr-derived adult category mappings.
