...
- Focused notification provider tests passed for generic webhook payload preservation, Discord/Slack webhook formatting, Ntfy topic delivery, Gotify message delivery, Telegram sendMessage formatting, and provider URL validation.
...
- `src/effect/services/NotificationService.ts`: in-app, generic webhook, Discord, Slack, Ntfy, Gotify, and Telegram notification channels.
...
- In-app, generic webhook, Discord, Slack, Ntfy, Gotify, and Telegram channels exist.
...
- [x] Add first-pass Discord, Slack, Ntfy, Gotify, and Telegram provider adapters using provider-specific webhook/topic/message payloads and Settings channel selection.
- Add provider adapters for email/SMTP, Notifiarr, Pushover, Apprise, and custom scripts.
