...
- Focused notification provider tests passed for generic webhook payload preservation, Discord/Slack webhook formatting, Ntfy topic delivery, Gotify message delivery, Telegram sendMessage formatting, Pushover form delivery, and provider URL/credential validation.
...
- `src/effect/services/NotificationService.ts`: in-app, generic webhook, Discord, Slack, Ntfy, Gotify, Telegram, and Pushover notification channels.
...
- In-app, generic webhook, Discord, Slack, Ntfy, Gotify, Telegram, and Pushover channels exist.
...
- [x] Add first-pass Discord, Slack, Ntfy, Gotify, Telegram, and Pushover provider adapters using provider-specific webhook/topic/message payloads and Settings channel selection.
- Add provider adapters for email/SMTP, Notifiarr, Apprise, and custom scripts.
