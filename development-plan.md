...
- `bun run test`: passed, 40 test files plus 1 skipped live suite, 410 passed and 4 skipped tests.
...
- [ ] Implement Option A:
  ...
  - [x] Add first-pass Cardigann HTML `rows.after` merging.
