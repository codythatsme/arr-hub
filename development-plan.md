...
- Focused notification provider tests passed for generic webhook payload preservation, Discord/Slack webhook formatting, and provider URL validation.
...
- `src/effect/services/NotificationService.ts`: in-app, generic webhook, Discord, and Slack notification channels.
...
- In-app, generic webhook, Discord, and Slack channels exist.
...
- [x] Add first-pass Discord and Slack provider adapters using provider-specific webhook payloads and Settings channel selection.
- Add provider adapters for Telegram, email/SMTP, Notifiarr, Ntfy, Pushover, Gotify, Apprise, and custom scripts.
