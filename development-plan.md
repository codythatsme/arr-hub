...
- Focused notification provider tests passed for generic webhook payload preservation, Discord/Slack webhook formatting, Ntfy topic delivery, Gotify message delivery, Telegram sendMessage formatting, Pushover form delivery, Apprise API delivery, and provider URL/credential validation.
...
- `src/effect/services/NotificationService.ts`: in-app, generic webhook, Discord, Slack, Ntfy, Gotify, Telegram, Pushover, and Apprise notification channels.
...
- In-app, generic webhook, Discord, Slack, Ntfy, Gotify, Telegram, Pushover, and Apprise channels exist.
...
- [x] Add first-pass Discord, Slack, Ntfy, Gotify, Telegram, Pushover, and Apprise provider adapters using provider-specific webhook/topic/message/API payloads and Settings channel selection.
- Add provider adapters for email/SMTP, Notifiarr, and custom scripts.
